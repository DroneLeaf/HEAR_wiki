% This script calculates the allocation matrix for a tricopter with front tilting rotor.
...
design_name = 'VTOL_design_D_Chehadeh';
...
% [roll_u pitch_u yaw_u thrust]' = moment_matrix * [M1 M2 M3 S1]'
...
moment_matrix_sym = [   0               -9.81*Y23*K23   9.81*Y23*K23    0;
                        -9.81*K1*X1     9.81*K23*X23    9.81*K23*X23    0;
                        0               0               0               1;
                        K1              K23             K23             0];
               
allocation_matrix_sym = inv(moment_matrix_sym);
...
minimum_pitch_moment = moment_matrix(2,:) * [1 0 0 0]';
maximum_pitch_moment = moment_matrix(2,:) * [0 1 1 0]';
...
max_absolute_roll_moment =  moment_matrix(2,:) * [0 1 0 0]'
