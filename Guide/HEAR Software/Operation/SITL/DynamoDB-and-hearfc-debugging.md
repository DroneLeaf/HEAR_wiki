...
1. Open VS Code in `~/software-stack/HEAR_FC/src/HEAR_FC`. [or ~/HEAR_FC/src/HEAR_FC if you have that repo cloned separately]   
...
### Tips
- Syncing DynamoDB from cloud to local would overwrite any local changes.
