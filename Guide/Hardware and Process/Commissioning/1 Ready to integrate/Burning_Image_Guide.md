...
- Update the PX4 firmware to the latest DroneLeaf firmware by connecting to the controller via USB-C and updating through QGC.
- Please refer to the release patches found in the release notes document and apply all commands there. [OS Images](https://droneleaf.sharepoint.com/:f:/s/technical/Eg2LOo9V0ANArVuQ_eN8DWIBshhVyvY0ty1XDy2FspXfbg?e=7FEXgf)
