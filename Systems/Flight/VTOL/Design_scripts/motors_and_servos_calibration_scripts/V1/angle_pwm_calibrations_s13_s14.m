...
% Allocation settings
s13_min_alloc=-((s13_idle_pwm-s13_min_pwm)/s13_pwm_range);
s13_max_alloc=((s13_max_pwm-s13_idle_pwm)/s13_pwm_range);
...
s13_alloc_post_alloc_bias=s13_min_alloc;
%% S14 settings
% IO settings
s14_io_range_min=0;
s14_io_range_max=1;
...
% Allocation settings
s14_min_alloc=-((s14_idle_pwm-s14_min_pwm)/s14_pwm_range);
s14_max_alloc=((s14_max_pwm-s14_idle_pwm)/s14_pwm_range);
...
s14_alloc_post_alloc_bias=s14_min_alloc;